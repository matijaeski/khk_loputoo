...
<fieldset >
<legend style="color: white;">Vaheta Salasõna</legend>
...
<div class='container'>
    <label for='oldpwd' >Vana salasõna*:</label><br/>
...
<div class='container'>
    <label for='newpwd' >Uus salasõna*:</label><br/>
...
<br/><br/><br/>
<div class='container'>
    <input type='submit' name='Submit' value='Vaheta' />
</div>
...
// <![CDATA[
    ...
    frmvalidator.addValidation("oldpwd","req","Palun sisesta vana salasõna");
    
    frmvalidator.addValidation("newpwd","req","Palun sisesta uus salasõna");
