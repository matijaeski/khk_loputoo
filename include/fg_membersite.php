...
class FGMembersite
{
    ...
    {
        $this->sitename = 'remoloc.local';
        $this->rand_key = 'ZWhQDejJlaseFj6';
    }
 ...
 public function checkhashSSHA($salt, $password) {
	...
	$validator->addValidation("expiredate","req","Palun sisesta aegumiskuupäev");
	...
	$formvars['expiredate'] = $this->Sanitize($_POST['expiredate']);
	...
	$salt = $hash["salt"];
		...
		"' . $confirmcode . '",
		"' . date("Y-m-d") . '",
                "' . $this->SanitizeForSQL($formvars['expiredate']) . '"
		)';  
