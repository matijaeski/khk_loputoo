...
<head>
      ...
      <title>Kasutajakonto aktiveerimine</title>
...
<?php }?>
<h2>Aktiveeri kasutajakonto</h2>
<p>
Et sisse logida oma uude kasutajasse, palun sisesta kinnituskood allolevasse lahtrisse.<br>
Kinnituskoodi saad seadme omanikult.
</p>
...
// <![CDATA[
    ...
    frmvalidator.addValidation("code","req","Palun sisesta kinnituskood");
...
<div>
<a class="a2" href="login.php">Logi sisse</a>
        </form>
</div>
<?php } elseif ($fgmembersite->UserFullName() == 'admin'){ ?>
<div>
<a class="a2" href="admin-page.php">Juhtpaneel</a>
	</form>
</div>
<?php } ?>
</body>
